(function(h, k, m, t) {
  "undefined" == typeof h.easyXDM &&
    (function(a, b, c, d, e, f) {
      ...
      function k() {
        if (!A(m.plugins) && "object" == typeof m.plugins["Shockwave Flash"]) {
      ...
      function t() {
        var a = parent;
        if ("" !== J)
          for (var b = 0, c = J.split("."); b < c.length; b++) a = a[c[b]];
        return a.easyXDM;
      }
      function r(a) {
      ...
      function E(a) {
        ...
        "string" == typeof a.container &&
          (a.container = b.getElementById(a.container));
        a.container ||
      ...
      function aa(g) {
        ...
        if (g.isHost)
          ...
          g.channel = x.xdm_c.replace(/["'<>\\]/g, "");
          g.secret = x.xdm_s;
          g.remote = x.xdm_e.replace(/["'<>\\]/g, "");
          d = x.xdm_p;
          var f;
          if ((f = g.acl)) {
            a: {
        ...
        switch (d) {
            ...
            if (g.isHost) {
              ...
              g.local === a
                ? ((g.usePolling = !0),
                  (g.useParent = !0),
                  (g.local =
                    c.protocol + "//" + c.host + c.pathname + c.search),
                  (d.xdm_e = g.local),
                  (d.xdm_pa = 1))
                : (d.xdm_e = K(g.local));
              g.container && ((g.useResize = !1), (d.xdm_po = 1));
              g.remote = B(g.remote, d);
            } else
              u(g, {
                channel: x.xdm_c,
                remote: x.xdm_e,
          ...
          case "1":
            ...
            break;
          case "2":
            g.isHost && (g.remoteHelper = K(g.remoteHelper));
            q = [
          ...
          case "5":
            ...
            break;
          case "6":
            F || k(), (q = [new l.stack.FlashTransport(g)]);
        }
      ...
      if ("readyState" in b) {
        ...
        G =
          "complete" == V ||
          (~m.userAgent.indexOf("AppleWebKit/") &&
            ("loaded" == V || "interactive" == V));
      } else G = !!b.body;
      if (!G) {
        if (h(a, "addEventListener")) C(b, "DOMContentLoaded", w);
        else if (
          (C(b, "readystatechange", function() {
            "complete" == b.readyState && w();
          }),
      ...
      l.DomHelper = {
        ...
        requiresJSON: function(c) {
          ("object" == typeof a.JSON && a.JSON) ||
            b.write(
              '<script type="text/javascript" src="' + c + '">\x3c/script>'
            );
        }
      };
      (function() {
        ...
        return (b = {
          ...
          onDOMReady: function() {
            ...
            a.isHost
              ...
              : ((f = t().Fn.get(a.channel)(function(a) {
                  b.up.incoming(a, e);
                })),
                d(function() {
                  b.up.callback(!0);
      ...
      l.stack.FlashTransport = function(a) {
        ...
        function e(c) {
          ...
          l.Fn.set("flash_loaded" + c.replace(/[\-.]/g, "_"), function() {
            ...
            for (
              var a = l.stack.FlashTransport[c].queue, b = 0;
              b < a.length;
              b++
            )
              a[b]();
        ...
        return (f = {
          ...
          onDOMReady: function() {
            ...
            g.isHost
              ...
              : (b.referrer &&
                  r(b.referrer) != x.xdm_e &&
                  (a.top.location = x.xdm_e),
      ...
      l.stack.NameTransport = function(a) {
        ...
        function c() {
          h
            ? (2 !== ++v && h) || e.up.callback(!0)
            : (b("ready"), e.up.callback(!0));
        }
        function f(a) {
          e.up.incoming(a, N);
        }
        ...
        return (e = {
          ...
          destroy: function() {
            ...
            k = null;
            h && (n.parentNode.removeChild(n), (n = null));
          },
          onDOMReady: function() {
            h = a.isHost;
            v = 0;
            ...
            var b = function() {
              ...
              (function S() {
                "function" == typeof f.contentWindow.sendMessage
                  ? c()
                  : d(S, 50);
              })();
            };
            k = E({ props: { src: a.local + "#_4" + a.channel }, onLoad: b });
          },
          init: function() {
            p(e.onDOMReady, e);
          }
      ...
      l.stack.HashTransport = function(b) {
        function c() {
          if (n) {
            ...
            b &&
              b != k &&
              ((k = b), f.up.incoming(k.substring(k.indexOf("_") + 1), N));
          }
        }
        var f, g, e, h, k, l, n, v, D, N;
        return (f = {
          outgoing: function(a, c) {
            if (v) {
              var d = b.remote + "#" + l++ + "_" + a;
              (g || !D ? v.contentWindow : v).location = d;
            }
          },
          destroy: function() {
            a.clearInterval(e);
            (!g && D) || v.parentNode.removeChild(v);
            v = null;
          },
          onDOMReady: function() {
            g = b.isHost;
            ...
            N = r(b.remote);
            if (g) {
              u(b.props, { src: b.remote, name: y + b.channel + "_provider" });
              if (D)
                b.onLoad = function() {
                  n = a;
                  e = setInterval(c, h);
                ...
                (function ia() {
                  ...
                  try {
                    n = v.contentWindow.frames[y + b.channel + "_consumer"];
                  } catch (S) {}
                  n ? ((e = setInterval(c, h)), f.up.callback(!0)) : d(ia, 50);
                })();
              }
              v = E(b);
            } else
        ...
        return (c = {
          ...
          incoming: function(b, d) {
            if (v) {
              ...
              k += b.substring(f + 1);
              0 === g &&
                (a.encode && (k = e(k)), c.up.incoming(k, d), (k = ""));
  ...
  ("undefined" != typeof h.uLogin && h.uLogin.uLoginHost) ||
      ...
      uLoginHost: (function(a) {
        ...
        for (b in a)
          if (
            b in a &&
            a[b].src &&
            /^https?:\/\/(.*?)\/js\/ulogin\.js/.test(a[b].src)
          ) {
            var c = a[b].src
              .match(/^https?:\/\/([^/]+)/)[1]
              .replace(/^www\./, "");
    ...
    (h.uLogin = {
      ...
      mobile: (function(a) {
        if (
          /_utl_t=vk/.test(location.href) ||
          /_utl_t=vk/.test(document.referrer)
        )
          return !1;
        a = a.toLowerCase();
        ...
        if (k.body) {
          ...
          if ("" != a) {
            ...
            if (b.display) {
              ...
              } else t('uLogin.init("' + a + '")', 1e3);
            }
          }
          this.add(k.body, "touchmove", this.touchMove);
          uLogin.timeouts.search_all = t(function f() {
            uLogin.findWidgets();
            if (
              ...
              return !1;
            uLogin.timeouts.all = t(f, 50);
          }, 50);
          this.findWidgets();
          uLogin.timeouts.search_ulogin = t(function n() {
            uLogin.checkAsyncWidgets();
            uLogin.timeouts.search_ulogin = t(n, 50);
          }, 50);
          this.checkAsyncWidgets();
          uLogin.timeouts.check_widgets = t(function z() {
            uLogin.checkCurrentWidgets();
            uLogin.timeouts.check_widgets = t(z, 300);
          }, 30);
      ...
      onMessage: function(a) {
        a.origin == "https://" + uLogin.uLoginHost &&
          ...
          "to_window" === a.data.func
            ...
            : h[a.data.func] &&
              h[a.data.func].apply(uLogin, a.data.args || []));
      },
      get: function(a) {
      ...
      scrollLeft: function() {
        return (
          h.pageXOffset || k.documentElement.scrollLeft || k.body.scrollLeft
        );
      },
      ...
      addWidget: function(a, b) {
        ...
        "undefined" !== typeof h.uLoginParams &&
          (h.uLoginParams[c]
            ...
            ? (e = h.uLoginParams[d])
            : 0 <
                this.arrayIntersectKey(h.uLoginParams, this.availableParams)
                  .length && ((e = h.uLoginParams), (f = !0)));
        b && (e = this.extend(e, b));
        var k =
          a.getAttribute("data-ulogin") || a.getAttribute("x-ulogin-params");
        f =
          null !== k ||
      ...
      initWidget: function(a) {
        if (a) {
          ...
          if (
            b &&
            (b =
              b.getAttribute("data-ulogin") ||
              b.getAttribute("x-ulogin-params")) &&
            !this.inited(a)
          ) {
            b = this.parse(b);
      ...
      setProp: function(a, b, c) {
        ...
        this.ids[b] = {
          ...
          altway:
            "undefined" !== typeof c.altway ? parseInt(c.altway) : this.altway,
        ...
        if (this.ids[b].hidden && "other" !== this.ids[b].hidden) {
          ...
          f = [];
          for (d in e)
            (h = e[d]), -1 < this.inArray(h, this.providerCodes) && f.push(h);
        ...
        this.ids[b].callback &&
          !this.ids[b].altway &&
          (this.ids[b].redirect_uri = "");
        this.ids[b].redirect_uri = this.clearRedirectUri(
          this.ids[b].redirect_uri
        );
        -1 == this.inArray(this.ids[b].lang, this.langs) &&
          (this.ids[b].lang = this.lang);
      ...
      initPanel: function(a) {
        ...
        this.ids[a].icons_16 && c
          ? (w = decodeURIComponent(this.ids[a].icons_16))
          : this.ids[a].icons_32 && !c
          ? (w = decodeURIComponent(this.ids[a].icons_32))
          : ((p = 120 < this.getPPI() ? (c ? 32 : 64) : c ? 16 : 32),
            (w = "providers-{size}-{theme}.png?version=img.3.0.1"
              .replace("{size}", p)
              .replace("{theme}", this.ids[a].theme)),
            (w = this.buildUrl("version/3.0/img/" + w)),
            (p = "smiles-{size}.png?version=img.3.0.1"
              .replace("{size}", p)
              .replace("{theme}", this.ids[a].theme)),
            (p = this.buildUrl("img/" + p)),
            (this.ids[a].hovered_sprite = p));
        w = "url(" + w + ") " + (c ? "0 -1px" : "0 -2px") + " no-repeat";
        b.innerHTML = "";
        if ("other" === this.ids[a].hidden) {
          var m = this.providerCodes.slice(0);
          if (this.ids[a].providers) {
            p = this.ids[a].providers.split(",");
            for (var r = 0; r < p.length; r++) {
              var t = this.inArray(p[r], m);
              -1 !== t && m.splice(t, 1);
            }
          }
          this.ids[a].hidden = m.toString();
        }
        if (this.ids[a].providers) {
          p =
          ...
          for (B in p)
            (f = p[B]),
              (m = this.inArray(f, this.providerCodes)),
              -1 < m &&
                ((d = k.createElement("div")),
                (d.className = "ulogin-button-" + f),
                d.setAttribute("data-uloginbutton", f),
                d.setAttribute("role", "button"),
                d.setAttribute("title", this.providerNames[m]),
                this.resetStyle(d, {
                  float: "left",
                  width: e,
                  height: e,
                  ...
                  background: w,
                  cursor: "pointer",
                  backgroundPosition: this.getIconPosition(c, m),
                  backgroundSize: z
                }),
      ...
      initWindow: function(a) {
        ...
        c.length
          ...
          : ((c = k.createElement("img")),
            c.setAttribute(
              "src",
              this.buildUrl("img/button.png?version=img.3.0.1")
            ),
      ...
      callbackReceived: function() {
        ...
        if (
          ...
          (this.callbackTryCall(a.ulogin_callback, a.ulogin_token),
          this.supportHistory)
        ) {
            ...
            style: this.extend(
              {
                ...
                width: "100%",
                height: "100%",
                boxShadow: "0 0 3px 4px rgba(0,0,0,.9)"
              },
              c
            ),
            frameBorder: "0"
          ...
          onMessage: function(a) {
            ...
            /^https?:\/\//.test(a)
              ...
              ? ((c = uLogin.buildUrl(a.replace(/to_window:\/?/, "", ""), {
                ...
                uLogin.loadWindow(c),
                /to_window:\/fill\.php/.test(a) &&
                  uLogin._changeState(d, "fill"))
              : /weights:/.test(a)
      ...
      loadWindow: function(a, b) {
        ...
        this.resetStyle(d, {
          ...
          width: "100%",
          height: "100%",
          background: "url(../image/texturs_bloc/fon3.webp)",
          display: "none",
        ...
        this.dialog = d;
        d = k.createElement("div");
        d.className = "ulogin-popup-close icon-cancel";
        this.resetStyle(d, {
          position: "absolute",
          width: 30,
          height: 30,
        ...
        // this.add(this.close, "mouseout", function(a) {});//событие
        this.newDialogSocket(
          this.initSocket(a, this.dialog.getAttribute("id"), {}, b)
        );
      ...
      dropdownDelayed: function(a, b) {
        ...
        this.ids[a].dropTimer = t(function() {
          uLogin.showDrop(a, b);
        }, 600);
      },
      ...
      getWidget: function(a, b) {
        ...
        if (
          this.waitGetWidget[a] &&
          -1 !== this.inArray(b, this.waitGetWidget[a])
        )
          return !1;
      ...
      _changeState: function(a, b, c) {
        try {
          for (var d = 0; this.listeners[this.ids[a].id]; )
    ...
    -1 == uLogin.inArray(uLogin.lang, uLogin.langs) &&
      (uLogin.lang = uLogin.langs[0]),
